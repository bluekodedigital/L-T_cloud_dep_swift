                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <button class="btn btn-primary"   style=" margin-top: 15%;" type="button" id="m_add" onclick="manual_add()" name="m_add">ADD</button>
                            </div>
...
//                                    $result = $cls_lc->select_lc($vid);
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr class="ty" id="removetr<?php echo $sr_id; ?>">
                                            <td>
                                            ...
                                            <td  class="pay_term" onkeypress="return isNumberKey(event)" id="pay_term<?php echo $sr_id; ?>"><?php // echo wordwrap($value['vqd_paytrm'], "<br>\n");                                   ?></td>
                                            <td><i class=" fa fa-trash text-danger pointer"  onclick="remove_tr('<?php echo $sr_id; ?>')"></i></td>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($res as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span onclick="get_lc_history('<?php echo $value['lcm_id'] ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="View Details">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="table-responsive">
                                    <table id="zero_config2" class="table table-bordered  ">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody >
                                            ...
                                            foreach ($res as $key => $value) {
                                                ...
                                                <tr class="ty">                                           
                                                    ...
                                                    <td>
                                                        <?php if ($value['lcr_lcid'] == "") { ?>
                                                            <i class=" fa fa-trash text-danger pointer"  onclick="remove_lcDetails('<?php echo $value['lcr_id']; ?>')"></i>
                                                        <?php } ?>
...
<script>
                                                ...
                                                function manual_add() {
                                                    ...
                                                    if (vendor == "") {
                                                        alert('Please select Vendor & Proceed');
                                                    } else if (projid == "") {
...
//                                                            }
                                                ...
                                                function append_table(projid, m_package, proj_name, sol_id) {
                                                    ...
                                                    var html = '<tr class="ty" id="removetr' + rowCount + '"><td><div class="custom-control custom-checkbox "><input type="checkbox" class="custom-control-input" value="' + rowCount + '"    id="customCheck' + rowCount + '"><label class="custom-control-label cpointer" for="customCheck' + rowCount + '" onclick="enable_cell(' + rowCount + ')"> </label></div></td>\n\
                                                                ...
                                                                <td <i class=" fa fa-trash text-danger pointer"  onclick="remove_tr(' + rowCount + ')"></i></td>\n\
                                                                </tr>';
                                                ...
                                                function remove_lcDetails(id) {

                                                    var r = confirm("Are you sure want to remove?");
                                                    if (r == true) {
                                                        $.post("code/remove_lcDetails.php", {key: id}, function (data) {
                                                            if ($.trim(data) == 1) {
