                                ...
                                <tbody>
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-medium text-white ml-1">ENG.-<?php echo $value['name'] ?> <br>(<?php echo formatDate($value['ctops_sentdate'], 'd-M-Y'); ?>)</span></td>
