    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Files From CTO</h5>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">                
                                ...
                                <tbody>
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-medium text-white ml-1">ENG.-<?php echo $value['name'] ?> <br>(<?php echo date('d-M-Y', strtotime($value['ctops_sentdate'])); ?>)</span></td>
                                            ...
                                            <td> 
                                               <div class="input-group" id="expdiv" style=" float: left;">
                                                ...
                                                <div class=" saveexp" style=" float: right;">
                                                    <span   class="badge badge-pill badge-success font-medium text-white ml-1" onclick="save_expected('<?php echo $value['ctops_packid'] ?>', '7')" data-toggle="modal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Save Expected date">
                                                        <i class="fas fa-save"></i>
                                                    </span>
                                                </div>
                                            </td>
                                            <!--<td><?php // echo date('d-M-Y', strtotime($value['actual'])); ?></td>-->
                                            <td><label class="badge badge-pill badge-warning font-medium text-white ml-1 pull-left orange" data-toggle="tooltip" data-original-title="CTO Remarks" style=" cursor: pointer;" onclick="swal({html: true, title: 'Remarks', text: '<?php echo $value['ctops_remarks']; ?>'});"><i class="fas fa-comment"></i> CTO Remarks</label></td>
                                            <td>                                               
