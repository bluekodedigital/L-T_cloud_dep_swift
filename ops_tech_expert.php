    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Ops Work Flow</h5>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style=" width: 120%;">
                        <div class="modal-header" style="padding-bottom: 3%;">
                            ...
                            <div class="row" id="daterow">
                                ...
                                <div class=" col-md-6" id="ps">
                                    <small>Received From:- <span class="badge badge-pill badge-primary font-medium text-white ml-1">Buyers</span></small>                          
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">    
                                <label class="badge badge-pill badge-warning font-medium text-white ml-1 pull-left"    data-toggle="tooltip"  data-original-title="Tech Remarks" style=" cursor: pointer;" 
                                       onclick="swal({html: true, title: 'Remarks', text: 'This is the tech expert remarks '});"><i class="fas fa-inbox"></i> Tech. Expert Remarks</label>
                                <label class="badge badge-pill badge-dark font-medium text-white ml-1 pull-left"    data-toggle="tooltip"  data-original-title="Tech  Previous Remarks" style=" cursor: pointer;" 
                                       onclick="swal({html: true, title: 'Tech Expert Remarks', text: '<?php echo $msg; ?>'});"><i class="fas fa-inbox"></i> Prev. Tech. Expert Remarks</label>       
                            </div>
                        </div>
                        <div class="modal-footer"> 
                            <a href="javacript:void(0)"  class="btn btn btn-rounded btn-outline-primary mr-2 btn-sm" data-toggle="tooltip"  data-original-title="Send to O&M"><i class="ti-check mr-1"></i>Send to Tech. Expert</a>
