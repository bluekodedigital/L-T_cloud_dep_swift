        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <?php if ($_SESSION['usertype'] == 2) { ?>
                    ...
                    <li class="sidebar-item">
                        <a href="scm_overall" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                ...
                <?php if ($_SESSION['usertype'] == 11) { ?>
                    <li class="sidebar-item">
                        <a href="tech_expert" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Action Board</span>
                        </a>
                    </li>
                ...
                <?php if ($_SESSION['usertype'] == 12) { ?>
                    <li class="sidebar-item">
                        <a href="tech_cto" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Action Board</span>
                        </a>
                    </li>
                ...
                <?php if ($_SESSION['usertype'] == 14) { ?>
                    <li class="sidebar-item">
                        <a href="scm_dash" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Action Board</span>
                        </a>
                    </li>
                ...
                <?php if ($_SESSION['usertype'] == 15) { ?>
                    <li class="sidebar-item">
                        <a href="om_dasboard" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Action Board</span>
                        </a>
                    </li>
                ...
                <?php if ($_SESSION['usertype'] == 0) { ?>
                    ...
                    <li class="sidebar-item">
                        <a href="dashboard" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Over all</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="package_category_master_edit" class="sidebar-link">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl" >
        <div class="modal-content" id="reports_content" style=" width: 117%; margin-left: -8.5%; margin-top: -1%;" >
