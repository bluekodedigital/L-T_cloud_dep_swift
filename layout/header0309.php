...
<html dir="ltr" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/extra-libs/datatables.net-bs4/css/datatableButtons.css" rel="stylesheet" type="text/css"/>
...
<!--        <div class="row" style="position: absolute; z-index: 9999; margin-left: 50%">            
            <center> <marquee class="text-danger" style="font-size:20px;; font-weight:bolder;">Your Subscription has been Expired!!</marquee> 
            </center>
        </div>-->
        <!-- ============================================================== -->
