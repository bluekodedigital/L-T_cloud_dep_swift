    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Ops call to Vendor</h5>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">                
            ...
            <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">              
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Ops call to Vendor</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<!--                                        <th>Stage Actual</th> -->
                                ...
                                <tbody>
                                    <?php
                                    $result = $cls_user->files_for_techapp($pid, $segment);
//                                    print_r($result);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                         if($value['expected']==""){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-info font-medium text-white ml-1 recfrm">
                                                    ...
                                                    ?>
                                                    <br> (<?php echo date('d-M-Y', strtotime($value['tech_sentdate'])); ?>)
                                                </span>
                                            </td>
                                            ...
                                            <td><?php // echo date('d-M-Y', strtotime($value['ps_expdate']));    ?>
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i class="icon-calender"></i></span>
                                                    </div>
                                                    <input type="text" value="<?php echo date('d-M-Y', strtotime($exp_date)); ?>"  class="mydatepicker" id="dasexpected_date<?php echo $value['tech_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">
