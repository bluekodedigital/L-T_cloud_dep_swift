...
if ($num_rows > 0) {
    $i = 0;
    ?>
    <center style="margin-left:30%;width:100%;"><b>O&M Attachments:</b> <img class="pointer" src="images/remarks.png" onclick="  new PNotify({
            title: 'OM Remarks',
            ...
            buttons: {
                ...
                });"><small style="cursor:pointer;"><span class="badge badge-pill badge-success font-12 text-white ml-1" id="expndate" onclick="downloadallv1('2');">Download</span></small> </center>
    ...
    <tbody >
        ...
        while ($row = mssql_fetch_array($query)) {
            ...
            <tr>
                ...
                <td class=" text-center"> <?php echo formatDate($row['om_update'], 'd-M-Y'); ?></td>
                <td class=" text-center"> <?php echo $row['om_filename']; ?></td>
                <td class=" text-center"><a href="swiftv1doc/uploads/om/<?php echo $path; ?>" class=" text-purple" target="_blank"> <?php echo $row['om_filepath']; ?> </a></td>
