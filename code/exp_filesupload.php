...
if (0 < $_FILES['file']['error']) {
    ...
    move_uploaded_file($_FILES['file']['tmp_name'], '../uploads/exp/' . $name);
...
//    $sql = "insert into swift_expert_uploads(exp_upid,exp_up_projid,exp_up_packid,exp_up_uid,exp_update,exp_filename,exp_filepath,exp_upactive,exp_rev,exp_tclid) "
//            . "values('" . $id . "','" . $projid . "','" . $pack_id . "','".$uid."',GETDATE(),'" . $doc_name . "','" . $name1 . "','1','".$exp_rev."','".$doc_id."')";
//   
