    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Files From Tech Head</h5>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">                
                <select class="custom-select" name="proj_Filter" id="proj_Filter" onchange="proj_Filter(this.value, '5')" required="">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered display compact">
                                ...
                                <tbody>
                                    <?php
                                    $result = $cls_user->files_fromcto($pid, $segment);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-medium text-white ml-1 recfrm">ENG.-<?php echo $value['name']; ?> <br>(<?php echo date('d-M-Y', strtotime($value['ctops_sentdate'])); ?>)</span></td>
                                            ...
                                            <td> 
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo date('d-M-Y', strtotime($exp_date)); ?>"  class="mydatepicker" id="dasexpected_date<?php echo $value['ctops_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">

                                                </div>
                                                <div class=" saveexp" style=" float: right;">
                                                    <span   class="badge badge-pill badge-success font-medium text-white ml-1 sicon" onclick="save_expected('<?php echo $value['ctops_packid'] ?>', '7')" data-toggle="modal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Save Expected date">
                            ...
                            <!--<td><?php // echo date('d-M-Y', strtotime($value['actual']));        ?></td>-->
                                            <td><label class="badge badge-pill badge-warning font-medium text-white ml-1 pull-left orange" data-toggle="tooltip" data-placement="bottom" data-original-title="CTO Remarks" style=" cursor: pointer;" onclick="swal({html: true, title: 'Remarks', text: '<?php echo $value['ctops_remarks']; ?>'});"><i class="fas fa-comment"></i> Tech Head Remarks</label></td>
                                            <td>                                               
                                                <span onclick="filesfromcto('<?php echo $value['ctops_packid'] ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Send Packages to Tech Spoc">
			...
			<input type="hidden" name="packid" id="packid">
                        ...
                        <form method="post" action="functions/ops_form"  onsubmit="return confirm('Are you sure you want to submit?');"> 
                            <div class="modal-body">
                                <center>
                                    <small> <span class="badge badge-pill badge-secondary orange font-12 text-white ml-1" id="senttitle">Ops to O&M</span></small>                
                                </center>
...
<!--                                            <input type="text" class="form-control mydatepicker" id="expected_date" name="expected_date" required="" placeholder="dd/mmm/yyyy">-->
                                ...
                                <div class=" row table-responsive" id="exp_uptable">
                                ...
                                <div class="form-group" id="expert_uploads">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input type="text" class="form-control" readonly="" id="doc_name" name="doc_name" value="Operation SignOff"   placeholder="Enter Document Name">
...
<!--                                            <input type="text" class="form-control" id="doc_name" name="doc_name"    placeholder="Enter Document Name">-->
                            ...
                            <div class="modal-footer">
                                <!--<button type="submit" id="sent_back_spoc" name="sent_back_spoc" class="btn-rounded btn btn-outline-danger btn-sm pull-left"><i class="ti-close mr-1"></i> Send Back To Tech SPOC</button>-->
                                <button type="submit" id="sent_back_toexpert" name="sent_back_toexpert" class="btn-rounded btn btn-outline-danger btn-sm pull-left"><i class="ti-close mr-1"></i> Send Back To Tech Expert</button>
                                <button type="submit" id="sent_toom" name="sent_toom" class="btn btn btn-rounded btn-outline-success mr-2 btn-sm"><i class="fa fa-paper-plane mr-1"></i> Send to O&M</button>
                                <!--<button type="submit" id="sent_toscm" name="sent_toscm" class="btn btn btn-rounded btn-outline-primary mr-2 btn-sm"><i class="fa fa-paper-plane mr-1"></i> Send to SCM</button>-->
                            </div>
                    </div>
                    </form>
                </div>
