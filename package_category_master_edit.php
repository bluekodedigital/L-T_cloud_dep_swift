    ...
    <div class="page-content container-fluid">
                        ...
                        <div class="tab-content border p-4" style=" margin-top: 3%">
                            ...
                            <div class="row" >
                                <form class="needs-validation" novalidate method="post" action="functions/package_category_form.php" autocomplete="off">
                                    ...
                                    <button class="btn btn-success" style=" display: none;" type="submit" id="package_cat_update" name="package_cat_update">Update</button>
                                    <button class="btn btn-primary" type="submit" id="package_cat_create" name="package_cat_create">Submit</button>
        ...
        <div class="form-group row">
            <div class="col-md-12">
                ...
                <?php } else if($msg == '0'){ ?>
                      <div class="alert alert-danger alert-rounded">  
                        <i class="fa fa-exclamation-triangle"></i> Package Category Does not Exists
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                    </div>
               <?php }
                ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span onclick="view_catmst('<?php echo $value['pc_id']; ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1"  style=" cursor: pointer;" data-toggle="tooltip" ><i class="fas fa-edit"></i> Edit</span>
                                              <a href="functions/package_category_form?catid=<?php echo $value['pc_id']; ?>">  <span class="badge badge-pill badge-danger font-medium text-white ml-1"  style=" cursor: pointer;" data-toggle="tooltip" >
