...
//                                    $result = $cls_comm->sentbackfromcto($pid, $_SESSION['uid']);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal_resize" style=" width: 120%;">
                        ...
                        <div class="modal-body">
                            <center>
                                <small> <span class="badge badge-pill badge-secondary orange font-12 text-white ml-1" id="senttitle">Tech. Expert to Reviewer for approval</span></small>                
                            </center>
