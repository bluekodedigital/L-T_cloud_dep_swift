    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Team Code </h5>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12 align-self-center">              
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Team Code </li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <input type="hidden" id="csrf_token" name="csrf_token" value="<?php  echo $generate_token;  ?>" />
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            <label for="tc_teamcode">Team Code </label>
                                            <input type="text"   class="form-control" maxlength="4" id="tc_teamcode"  name="tc_teamcode" placeholder="Team Code" value="" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-12 mb-12">
                                            ...
                                            <input type="text"   class="form-control" maxlength="200" id="tc_teamname"  name="tc_teamname" placeholder="Team Name" value="" required>
                                            <div class="invalid-feedback">
            ...
            <div class="col-md-12">
                ...
                if (isset($_GET['msg'])) {
                    ...
                    <div class="alert alert-danger alert-rounded">  
                        <i class="fa fa-exclamation-triangle"></i> Team Code  already exsists
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="material-card card">
                    <div class="card-body">
                        <h4 class="card-title">Team Code </h4>
                                ...
                                <tbody>
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['tc_teamcode'] ?></td>                                             
                                            <td><?php echo $value['tc_teamname'] ?></td>                                             
                                             
                                            <td>
                                                <span onclick="view_teammst('<?php echo $value['tc_id']; ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1"  style=" cursor: pointer;" data-toggle="tooltip" ><i class="fas fa-edit"></i> Edit</span>
                                              <!--<a href="functions/package_category_form?catid=<?php // echo $value['pc_id']; ?>">-->  
                                                  <span onclick="delete_teammst('<?php echo $value['tc_id']; ?>')" class="badge badge-pill badge-danger font-medium text-white ml-1"  style=" cursor: pointer;" data-toggle="tooltip" >
