...
<!--                                        <th>Stage Actual</th>                                      -->
    ...
    <!--                                            <td><?php echo date('d-M-y'); ?></td>-->
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getrpa('<?php echo $getid ?>', '<?php echo $value['cm_pack_id'] ?>')" data-toggle="modal" data-target="#exampleModal" style=" cursor: pointer;" > <i class="fas fa-paper-plane"></i></span>
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                <div class=" col-md-6" id="pd">
                                    <small>Planned Date:- <span class="badge badge-pill badge-info font-12 text-white ml-1" id="planned_date1"></span></small>                           
                                </div>
                                <div class=" col-md-6" id="ps">
                                    <small>Expected Date:- <span class="badge badge-pill badge-primary font-12 text-white ml-1" id="mat_req_date1"></span></small>                          
                                </div>
                            </div>
                        </div>
                        <div class="modal-body">
                            <form method="post" class="needs-validation" action="functions/lc_rpa_entry.php" autocomplete="off">                            
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="lpo_number" name="lpo_number" readonly="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                                ...
                                <div class="form-group">
                                    <div class="example">
                                        ...
                                        <div class="input-daterange input-group" id="date-range1">
                                            <input type="text" class="form-control mydatepicker" name="start_rpa" />
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-info b-0 text-white">TO</span>
                                            </div>
                                            <input type="text" class="form-control mydatepicker" name="end_rpa" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary btn-rounded" name="rpa_create" id="submitbtn" ><i class="fas fa-paper-plane"></i> RPA Save </button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
                                                        ...
                                                        function swift_proj(Proid) {
                                                            window.location.href = "rpa_page?pid=" + Proid;
                                                        }
