    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">PO Approval Update</h5>
            </div>
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getsid('<?php echo $getid; ?>', '<?php echo $projname; ?>', '<?php echo $value['so_pack_id']; ?>', '<?php echo $value['ps_stageid'] ?>')" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Send Packages to Tech Spoc"> <i class="fas fa-paper-plane"></i> </span>
