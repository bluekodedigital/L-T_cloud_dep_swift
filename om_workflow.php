                                        ...
                                        <tr>
                                            ...
                                            <td><?php // echo formatDate($value['actual'], 'd-M-Y');      ?>
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo formatDate($exp_date, 'd-M-Y'); ?>"  class="mydatepicker" id="dasexpected_date<?php echo $value['om_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">
