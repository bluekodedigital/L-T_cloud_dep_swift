...
<div class="page-wrapper">
    ...
    <div class="page-content container-fluid">
        <div class="row">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        <?php
                                        $result = $cls_count->scm_workflow_count($pid,$seg);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="files_from_buyer?pid=<?php echo $pid ?>">
                    <div class="card bg-warning">
                        <div class="d-flex flex-row">
                            <div class="p-2">
                                <h3 class="text-white box mb-0"><i class="ti-direction-alt"></i></h3>
                            </div>
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        <?php
                                        $result = $cls_count->files_from_buyer_count($pid,$seg);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
                                <span class="text-white">Files sent back from buyer</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="scm_repository?pid=<?php echo $pid ?>">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        <?php
                                        $result = $cls_comm->scm_repository($pid,$seg);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
...
<!--            <div class="col-lg-3 col-md-6">
                <a href="scm_overall?pid=<?php echo $pid ?>">
                    <div class="card" style="background-color:#29bac9;">
                        <div class="d-flex flex-row">
                            <div class="p-2">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        <?php
                                        $result = $cls_comm->over_allcount($pid);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
                                <span class="text-white">Over all</span>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="row" id="dashtbl" style=" display: none;">
            <div class="col-12">
