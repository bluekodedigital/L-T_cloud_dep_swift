...
foreach ($fetch_rpa as $key => $value) {
    $lc_date = formatDate($value['rpa_date'], 'd-M-y');
    $lc_from = formatDate($value['rpa_from'], 'd-M-y');
    $lc_to = formatDate($value['rpa_to'], 'd-M-y');
    $lc_value = "";
    $lc_balance = "";
    $lcm_id = $value['rpa_id'];
}
$flag=0;
$povalue=$cls_user->get_wovalue($pack_id);
...
<div class="modal-body">
    ...
    <form method="post" class="needs-validation" action="functions/rpa_apply_wo.php" onsubmit=" return confirm('Are you sure you want to apply?');" autocomplete="off">      
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" value="<?php echo $wo_num; ?>" class="form-control" id="rpo_number" name="rpo_number" readonly="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
