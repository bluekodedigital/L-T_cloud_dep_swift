...
<div class="modal-body">
    ...
    <form method="post" class="needs-validation" action="functions/lc_apply_wo.php" onsubmit=" return confirm('Are you sure you want to apply?');" autocomplete="off">      
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" value="<?php echo $wo_num; ?>" class="form-control" id="lpo_number" name="lpo_number" readonly="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
