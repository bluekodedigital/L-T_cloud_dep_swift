                ...
                <div class="card">
                    <div class="card-body" id="tab_select">
                        ...
                        <ul class="nav nav-pills mt-4 mb-1">
                            <li class=" nav-item"> <a href="#navpills-1" class="nav-link active" data-toggle="tab" aria-expanded="false">LC For PO</a> </li>
                            <li class="nav-item"> <a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">Lc For WO</a> </li>
                        </ul>
...
<!--                                                                <th>Remarks</th>-->
    ...
    <!--                                                                    <td><label class="badge badge-pill  font-medium text-white ml-1 orange" data-toggle="tooltip"  data-original-title="OPS Remarks" style=" cursor: pointer;" 
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getlc('<?php echo $getid ?>', '<?php echo $value['cm_pack_id'] ?>')" data-toggle="modal" data-target="#exampleModal" style=" cursor: pointer;" > <i class="fas fa-paper-plane"></i></span>
