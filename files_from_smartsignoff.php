    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">EMR From OPS</h5>
            </div>
            ...
            <div class="col-lg-5 col-md-5 col-xs-12 align-self-center">              
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">EMR From Ops</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_smartsignoff($pid, $uid, $utype, $seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        $rdate = $cls_comm->datechange(formatDate($value['so_package_approved_date'], 'Y-m-d'));
                                        ...
                                        $em = $cls_user->emr_check($value['so_pack_id']);
                                        if ($em !== "") {
                                            ?>
                                            <tr>
                                                ...
                                                <!--<td><span class="badge badge-pill badge-info font-12 text-white ml-1"><?php echo $value['stage_name']; ?> <br> (<?php echo $rdate; ?>)</span></td>-->
                                                <td><span class="badge badge-pill badge-info font-12 text-white ml-1 recfrm">EMR From OPS <br> (<?php echo $rdate; ?>)</span></td>

                                                <td>
                                                    <?php
                                                    $check_emr = $cls_user->emr_check($value['so_pack_id']);
                                                    echo $check_emr;
                                                    ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    if ($em == "") {
                                                        ?>
                                                        <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="swal('EMR Not Created Yet')" style=" cursor: pointer;" > <i class="fas fa-paper-plane"></i> </span>

                                                    <?php } else { ?>
                                                        <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getsid('<?php echo $getid; ?>', '<?php echo $projname; ?>', '<?php echo $value['so_pack_id']; ?>', '<?php echo $value['ps_stageid'] ?>')" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" > <i class="fas fa-paper-plane"></i> </span>
...
<script>
                                                            function getsid(a, b, c, d) {
                                                                ...
                                                                $.post("functions/po_wo_checking.php", {key: pack_id, stageid: d}, function (data) {
                                                                    $('#powo').html(data);
                                                                });
                                                            }
