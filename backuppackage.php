                                ...
                                <tbody>
									...
									$counts=1;
									  $result1 = $cls_comm->stage_master();
                                        ...
                                        <tr>
                                            <td id='sum'><?php echo $counts;?></td>

                                            <td><?php echo $value1['stage_name'];?></td>
                                            <td><input type="checkbox" onclick="changecheck(<?php echo $counts;?>);"  id="check"  value="datee"></td>
                                            <td><input type='text'id='result<?php echo $counts;?>'readonly name='date[]' > </td>
...
//                                                var attach = $('#inputGroupFile01').val();
                                            ...
                                            function omflowvalidate(pid) {
                                                $.post("code/omflowvalidate.php", {proj_id: pid}, function (data) {
                                                    if ($.trim(data) == 35) {
                                                        $('.omflow').show();
                                                        $('#omsegs').val(35);
...
//                                                    {
                                                        $.post("code/omdelete.php", {op: "delete", name: data},
