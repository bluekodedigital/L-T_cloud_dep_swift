...
<!--                                        <th>Location</th>-->
                                ...
                                foreach ($res as $key => $value) {
                                   ...
                                   // $select_projtype = $cls_comm->projtype($value['proj_type']);
                                    ...
                                    <td><?php echo date('d-M-y', strtotime($value['proj_created_date'])); ?> </td>
                                    <td><?php echo date('d-M-y', strtotime($value['proj_edate'])); ?></td>
                                    <td><?php echo date('d-M-y', strtotime($value['proj_revised_edate'])); ?> </td>
                                    <td>
                                    <?php
