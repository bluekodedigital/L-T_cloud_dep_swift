    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Work Order Create</h5>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
            ...
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">WORK ORDER CREATE</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_swiftwo($pid, $uid, $utype, $seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
...
<script>
    function getsid(a, b, c, d) {
        ...
        $.post("functions/po_wo_checking1.php", {
            key: pack_id,
            stageid: d
        }, function (data1) {
            console.log(data1);
    ...
    function swift_proj(Proid) {
        ...
        window.location.href = "files_for_ops_wo_entry?pid=" + Proid + "&ptid=" + tid;
    }
