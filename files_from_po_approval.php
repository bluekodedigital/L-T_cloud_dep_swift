                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_swiftpo_app($pid, $uid, $utype, $seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        $rdate = $cls_comm->datechange($value['cs_created_date']);
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><label class="badge badge-pill  font-medium text-white ml-1 orange" data-toggle="tooltip" data-original-title="Remarks" style=" cursor: pointer;" onclick="swal('<?php echo $value['ps_remarks'] ?>');"><i class="fas fa-comment"></i> Remarks</label> </td>
