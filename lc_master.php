                        ...
                        <form class="needs-validation" method="post" action="functions/lc_form" autocomplete="off">
                            <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="applicant"  name="applicant" placeholder="Applicant Name" value="L&T" readonly="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="custom-select" name="vendor" id="vendor" required="">
                                        ...
                                        if ($vid == "") {
                                            ...
                                            $result = $cls_lc->vendor_select_by_vendor($vid);
                                        }
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bf_bank"  name="bf_bank" placeholder="Benificiary Bank" value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bf_bank_address"  name="bf_bank_address" placeholder="Beneficiary Bank Address" value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inco_terms"  name="inco_terms" placeholder="Inco Terms" value="" required>
                                    <div class="invalid-feedback">
...
<!--<input type="text" class="form-control" id="country"  name="country" placeholder="Country Of Supply" value="" required>-->
                                    <select class="custom-select"  id="country"  name="country" required=""  >
                                        <option value="">--Select Country --</option>
                                        <?php
                                        $result = $cls_lc->select_country();
                                        $res = json_decode($result, true);
                                        foreach ($res as $key => $value) {
                                            ?>
                                            <option value="<?php echo $value['country_name'] ?>" name="<?php echo $value['country_name'] ?>"><?php echo $value['country_name']; ?></option>
                                        <?php } ?>
    ...
    <!--                                            <td><?php // echo $value['cp_period'];   ?></td>-->
                                            ...
                                            <td>
                                                <span class="badge badge-pill badge-danger font-medium text-white ml-1" onclick="changelc('<?php echo $value['lcm_id']; ?>', '0')"    style=" cursor: pointer;" > <i class=" fas fa-pencil-alt"></i></span>
                                            </td>
...
//    alert(name);
                                                ...
                                                function calculate() {
                                                    ...
                                                    if (currency == "") {
                                                        ...
                                                        var rate_with1 = rate_wo;
                                                        var rate_with = rate_wo * forex;
                                                        $('#inr_val').val(rate_with.toFixed(2));
                                                        var total_po = +$('#total_po').text().replace(/,/g, "");
                                                        var lcid =$('#lcid').val();
                                                         
                                                        if(total_po < rate_with1 ){
                                                            if(lcid == ""){
                                                                $('#lcmst_create').hide();
                                                                $('#errordiv').show();
