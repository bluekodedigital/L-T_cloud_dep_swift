...
$proj_type = $cls_comm->select_project_type($seg);
                ...
                <div class="material-card card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" style=" white-space: nowrap !important;     "
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_swiftsendback_workflow($pid, $segment);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        $stage_names = $cls_comm->get_stagenames($getid, $stageid1, $stageid);
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $projname ?>
                                                <?php if ($value['proj_type'] != '') { ?>
                                                    <span class="blink">
                                                        <span
                                                            class='type_sty <?php echo $ptype_col; ?>'><?php echo $ptype; ?></span>
                                            ...
                                            <td style=" min-width: 130px !important;">
                                                ...
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo $except_date; ?>"
                                                        class=" mydatepicker"
                                                        id="dasexpected_date<?php echo $value['cs_packid'] ?>"
                                            ...
                                            <td><label class="badge badge-pill  font-medium text-white ml-1 orange "
                                                    data-toggle="tooltip" data-original-title="From Remarks"
                                                    data-placement="bottom" style=" cursor: pointer;"
                                                    onclick="swal('<?php echo $value['to_remark'] ?>');"><i
                                                        class="fas fa-comment"></i> Remarks</label></td>

                                            <td>
                                                <?php if ($hold_flag != 1) { ?>
                                                    <span style="background-color:#5abf76;"
                                                        class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                        onclick="getspocid('<?php echo $getid ?>', '<?php echo $projname ?>', '<?php echo $value['cs_packid'] ?>','<?php echo $stageid1; ?>','<?php echo $stageid ?>','<?php echo $value['cs_projid']; ?>','<?php echo $scmbu_id; ?>')"
                                                        data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"
                                                        style=" cursor: pointer;" data-toggle="tooltip"
                                                        data-original-title="Send Packages to Tech Spoc"> <i
                                                            class="fas fa-paper-plane"></i> </span>
                                                <?php } else { ?>
                                                    <span class="badge badge-pill badge-danger font-medium  ml-1"
                                                        style=" cursor: pointer;color: #212529;background-color: #ffc36d;">On
                                                        Hold</span>
                                                <?php } ?>
                                                <!-- <span style="background-color:#5abf76;" class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getspocid('<?php echo $getid ?>', '<?php echo $projname ?>', '<?php echo $value['cs_packid'] ?>','<?php echo $stageid1; ?>','<?php echo $stageid ?>','<?php echo $value['cs_projid']; ?>','<?php echo $scmbu_id; ?>')" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip" data-original-title="Send Packages to Tech Spoc"> <i class="fas fa-paper-plane"></i> </span></td> -->
                                            ...
                                            <td>
                                                <span
                                                    onclick="view_reports('<?php echo $value['cs_packid']; ?>','<?php echo $value['cs_projid']; ?>')"
                                                    class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                ...
                                                <span
                                                    onclick="view_reports_table('<?php echo $value['cs_packid']; ?>','<?php echo $value['cs_projid']; ?>')"
                    ...
                    <div class="modal-content modal_resize" style=" width: 120%;">
                        <div class="modal-header" style="padding-bottom: 1% !important;    margin-right: 3%;">
                            <div class=" col-md-12" class="modal-title" id="exampleModalLabel1">
                                <span class="control-label bold" style="color: #09aef7;font-weight: 500;"><b>Package
                                        Name : </b></span>
                                <span class="control-label bold" style="font-weight: 500;" id="pack"></span>
                                <label for="message-text" class="control-label bold" style="margin-left: 31%;">Planned
                                    Date : </label> <span class="badge badge-pill badge-info font-12 text-white ml-1"
                                    id="planned_date"></span>
                                <label for="message-text" class="control-label bold">Expected Date : </label><span
                                    class="badge badge-pill badge-primary font-12 text-white ml-1"
                                    id="mat_req_date"></span>
                                <center>
                                    <small> <span
                                            class="badge badge-pill badge-secondary orange font-12 text-white ml-1"
                                            style="font-weight: bold !important;font-size:14px;"
                                            id="senttitle"></span></small>
                                </center>
                            </div>
                        ...
                        <div class="modal-body">
                            <center>
                                <small> <span class="badge badge-pill badge-secondary orange font-12 text-white ml-1"
                                        id="senttitle"></span></small>
                            </center>
                            <form id='approve_validate' method="post" class="needs-validation" novalidate
                                action="functions/move_to_next_stage.php" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <input type="hidden" class="form-control mydatepicker" id="exp_date"
                                            name="exp_date" required="" placeholder="mm/dd/yyyy">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control mydatepicker"
                                                    style=" margin-bottom: 0px !important;" disabled="" id="act_date"
                                                    name="act_date" onchange="samedate(this.value)" required=""
                                                    placeholder="mm/dd/yyyy">
                                            </div>
                                        </div>

                                        <div class="col-md-6" id='finalstage' style="display:block;">
                                    ...
                                    <div class="row" id='loi_inputs' style="display:none;">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="loi_number"
                                                    name="loi_number" placeholder="Enter LOI Number">
                                            </div>
                                            <div class="invalid-feedback"> </div>
                                        </div>
                                        <div class="col-md-2 mb-3" style="margin-top: 3.5%;">
                                            <label> PO/WO Applicable : </label>
                                            </br>
                                        </div>
                                        <div class="col-md-2 mb-3" style="margin-left: -3%;">
                                            <div class="input-group" style="top: 58%;">
                                                <label style=" cursor: pointer;">
                                                    <input style=" cursor: pointer;" type="radio" name="po_wo"
                                                        value="1" /> PO
                                                    <input style=" cursor: pointer;" type="radio" name="po_wo"
                                                        value="2" /> WO
                                                    <input style=" cursor: pointer;" type="radio" name="po_wo"
                                        ...
                                        <div class="col-md-2 mb-3" style="margin-left: 3%;margin-top: 3.5%; ">
                                            <label for="deal"> Deal Path </label>
                                            <input style=" cursor: pointer;" class="deal_checkbox button_check"
                                                type="checkbox" name="deal_checkbox" />
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="site_name"> Site Planning / Business </label>
                                            <!-- <input style=" cursor: pointer;" class="flag_checkbox" checked type="checkbox" name="flag[]" value="1" /> -->
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="site_name" name="site_name"
                                                    placeholder="Enter Contact Name">
                                            </div>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="site_mobno"
                                                    name="site_mobno" placeholder="Enter Mobile Number">
                                            </div>
                                            <div class="input-group">
                                                <input type="email" class="form-control" id="site_mailid"
                                                    name="site_mailid" placeholder="Enter Mail id">
                                            </div>
                                            <div class="invalid-feedback"> </div>
                                        </div>
                                        <div class="col-md-3 mb-3" id='Dist_show' style="display:none;">
                                            <label for="dist1_name">Distributor 1</label>
                                            <!-- <input style=" cursor: pointer;" checked type="checkbox" class="flag_checkbox" name="flag[]" value="2" /> -->
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="dist1_name"
                                                    name="dist1_name" placeholder="Enter Contact Name">
                                            </div>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="dist1_mobno"
                                                    name="dist1_mobno" placeholder="Enter Mobile Number">
                                            </div>
                                            <div class="input-group">
                                                <input type="email" class="form-control" id="dist1_mailid"
                                                    name="dist1_mailid" placeholder="Enter Mail id">
                                            </div>
                                            <div class="invalid-feedback"> </div>
                                        </div>
                                ...
                                <div class="form-group" id="expert_uploads" style="display:none;">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-1 mb-2">
                                            <div class="input-group-append">
                                                <button class="btn btn-success" type="button" id="ops_expert_filesup"
                                    ...
                                    <div class="table-responsive" id="ops_exp_uptable">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8" style="margin-top:1%;">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="6" id="remarks" name="remarks"
                                                style="height: calc(1em + 3.75rem + 6px) !important;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row backto" style="display:none;">
                                    <div class="col-md-4">
                                        ...
                                        <select class="custom-select" name="senbackstage" id="senbackstage"
                                            onchange="appendName();">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <!-- <input type="hidden" name="senbackuid" id="senbackuid" class="form-control" readonly> -->
                                            <!-- <input type="text" name="uname" id="uname" class="form-control" readonly> -->
                                            <select class="custom-select" name="senbackuid" id="senbackuid">
                                ...
                                <div class="modal-footer">
                                    <button style="display:none;" type="submit" value='1'
                                        class="btn waves-effect waves-light btn-rounded btn-outline-danger pull-left click"
                                        id='backEnable' name="sent_back_to_previous" data-toggle="tooltip"
                                        data-placement="top" title="Send Back"> <i class="fas fa-times"></i> Send
                                        Back</button>
                                    <button type="submit" value='0' class="btn btn-outline-primary btn-rounded click"
                                        name="approve_package" id="button_check" data-toggle="tooltip"
                                        data-placement="top" title="Approve"><i
                                            class="fas fa-paper-plane"></i>Approve</button>
                                </div>
...
<script>
        ...
        $.post("functions/filesfromBack.php", {
            ...
            if (file_attach == 1) {
                ...
                if (from == 4) {
                    ...
                    option3 += '<option value="" >---Select Document Name--</option>';
    ...
    // Update the hidden input field when a different user is selected
    $('#forward').on('change', function () {
        $('#forwardto').val($(this).val());
    });
    ...
    function swift_proj(Proid) {
        ...
        window.location.href = "sentbackfromreviewerFlow?pid=" + Proid + "&ptid=" + tid;
    }
