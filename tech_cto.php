    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="tech_cto_workflow?pid=<?php echo $pid ?>">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        ...
                                        $result = $cls_count->tech_cto_workflow_countM($pid,$userid,$seg);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
                                <span class="text-white">Files From Expert/Reviewer</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-6">
                <a href="tech_cto_repository?pid=<?php echo $pid ?>"><div class="card bg-success">
                        <div class="d-flex flex-row">
                            <div class="p-2">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0">
                                        ...
                                        $result = $cls_count->tech_cto_repository_countM($pid,$userid,$seg);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
