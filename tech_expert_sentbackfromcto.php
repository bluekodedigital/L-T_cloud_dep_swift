                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" style=" white-space: nowrap !important;"  class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $result = $cls_comm->sentbackfromcto($pid, $_SESSION['uid'],$seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
...
<!--                                            <input type="text" class="form-control" id="doc_name" name="doc_name"    placeholder="Enter Document Name">-->
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary btn-rounded pull-left" name="sendtoreviewer" data-toggle="tooltip" data-placement="top" title="Send to Tech Reviewer"><i class="fas fa-paper-plane"></i> Send to Reviewer</button>
