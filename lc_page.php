    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">LC WorkFlow</h5>
            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        if (isset($_GET['msg'])) {
                                            ...
                                            <div class="alert alert-danger alert-rounded">  
                                                <i class="fa fa-exclamation-triangle"></i>LC validity has been expired.
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                                            </div>
                                        <?php } else if ($msg == '1') { ?>
                                            <div class="alert alert-danger alert-rounded">  
                                                <i class="fa fa-exclamation-triangle"></i>LC value exceeds balance value
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                                            </div>
                                        <?php }
                                        ?>
    ...
    <!--                                                                    <td><label class="badge badge-pill  font-medium text-white ml-1 orange" data-toggle="tooltip"  data-original-title="OPS Remarks" style=" cursor: pointer;" 
                                                                    ...
                                                                    <td>
                                                                        <?php if ($po_num == "") { ?>
                                                                            ...
                                                                            $check_vendorlc = $cls_user->check_vendorlc($vq_venid);
                                                                            ?>
                                                                            <?php if ($check_vendorlc == '') { ?>
                                                                                <span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="swal('LC Number not created for this Vendor')"   style=" cursor: pointer;" > <i class="fas fa-paper-plane"></i></span>

                                                                            <?php } else { ?>
                                                                                <span class = "badge badge-pill badge-primary font-medium text-white ml-1" onclick = "getlccontent('<?php echo $getid ?>', '<?php echo $value['cm_pack_id'] ?>')" data-toggle = "modal" data-target = "#exampleModal" style = " cursor: pointer;" > <i class = "fas fa-paper-plane"></i></span>
                                                                            <?php }
                                                                            ?>
...
<!--                                                                <th>Remarks</th>-->
    ...
    <!--                                                                    <td><label class="badge badge-pill  font-medium text-white ml-1 orange" data-toggle="tooltip"  data-original-title="OPS Remarks" style=" cursor: pointer;" 
                                                                    ...
                                                                    <td>
                                                                        <?php if ($wo_num == "") { ?>
                                                                            ...
                                                                            <?php } else { ?>
                                                                                <span class = "badge badge-pill badge-primary font-medium text-white ml-1" onclick = "getlccontent_wo('<?php echo $getid ?>', '<?php echo $value['cm_pack_id'] ?>')" data-toggle = "modal" data-target = "#exampleModal" style = " cursor: pointer;" > <i class = "fas fa-paper-plane"></i></span>
                                                                            <?php }
                                                                            ?>
                                                                        <?php }
                                                                        ?>
    ...
    <script>
                                                                                    function getlccontent(a, b) {
                                                                                        var getid = a;
                                                                                        var pack_id = b;
                                                                                        $("#lc_row_id").val(getid);
                                                                                        $("#lc_pack_id").val(pack_id);
                                                                                        $.post("functions/lc_content.php", {key: pack_id}, function (data) {
                                                                                            $('#lc_content').html(data);
                                                                                        });
                                                                                    }
                                                                                     function getlccontent_wo(a, b) {
                                                                                        var getid = a;
                                                                                        var pack_id = b;
                                                                                        $("#lc_row_id").val(getid);
                                                                                        $("#lc_pack_id").val(pack_id);
                                                                                        $.post("functions/lc_content_wo.php", {key: pack_id}, function (data) {
                                                                                            $('#lc_content').html(data);
                                                                                        });
                                                                                    }
                                                                                    function getlc(a, b) {
