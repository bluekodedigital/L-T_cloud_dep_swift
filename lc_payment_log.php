    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Payment Log</h5>
            </div>
            ...
            <div class="col-lg-5 col-md-5 col-xs-12 align-self-center">              
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Payment Log</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config_lc" class="table table-bordered  ">
                                ...
                                <tbody>
                                    <?php
                                    $result = $cls_lc->select_supply_payment_log($lc);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ?>
                                        <tr>
...
<script>
                    ...
                    function swift_proj(Proid) {
                        window.location.href = "lc_payment_log?lc=" + Proid;
                    }
