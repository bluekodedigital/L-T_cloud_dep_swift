    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Files From SCM</h5>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">                
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered display compact">
                                ...
                                <tbody>
                                    <?php
                                    $result = $cls_user->files_from_scm($pid, $segment);
//                                    print_r($result);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                          if($value['ps_expdate']==""){
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-medium text-white ml-1 recfrm">SCM-<?php echo $value['name'];?> <br> (<?php echo date('d-M-Y', strtotime($value['scop_sentdate'])); ?>)</span></td>
                                            ...
                                            <td>
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo date('d-M-Y', strtotime($exp_date)); ?>"  class="mydatepicker" id="dasexpected_date<?php echo $value['scop_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">

                                                </div>
                                                <div class=" saveexp" style=" float: right;">
                                                    <span   class="badge badge-pill badge-success font-medium text-white ml-1 sicon" onclick="save_expected('<?php echo $value['scop_packid'] ?>', '8')" data-toggle="modal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Save Expected date">
                                            ...
                                            <td><label class="badge badge-pill badge-warning font-medium text-white ml-1 pull-left orange" data-toggle="tooltip" data-original-title="SCM Remarks" style=" cursor: pointer;" onclick="swal({html: true, title: 'Remarks', text: '<?php echo $value['scop_remarks']; ?>'});"><i class="fas fa-comment"></i> SCMRemarks</label></td>
                                            <td>                                               
                                                <span onclick="filesfrom_scm('<?php echo $value['scop_packid'] ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Send Packages">
...
<!--                                           <select class="custom-select" name="doc_name" id="doc_name"  required="">
                                            ...
                                            <input type="hidden" class="form-control" id="doc_name" name="doc_name"    placeholder="Enter Document Name">
                                    ...
                                    <div class=" col-md-12 table-responsive" id="ops_exp_uptable">
                                    </div>
                            ...
                            <div class="modal-footer">
                                <!--<button type="submit" id="sent_back_spoc_scm" name="sent_back_spoc_scm" class="btn-rounded btn btn-outline-danger btn-sm pull-left"><i class="ti-close mr-1"></i> Send Back To Tech SPOC</button>-->
                                <button type="submit" id="sent_back_expert_scm" name="sent_back_expert_scm" class="btn-rounded btn btn-outline-danger btn-sm pull-left"><i class="ti-close mr-1"></i> Send Back To Tech Expert</button>
                               
                                
                                <button type="submit" id="sent_toom_scm" name="sent_toom_scm" class="btn btn btn-rounded btn-outline-success mr-2 btn-sm"><i class="fa fa-paper-plane mr-1"></i> Send to O&M</button>
                                <button type="submit" id="sent_toscm_scm" name="sent_toscm_scm" class="btn btn btn-rounded btn-outline-primary mr-2 btn-sm"><i class="fa fa-paper-plane mr-1"></i> Send to SCM</button>
                            </div>
                    </div>
                    </form>
                </div>
