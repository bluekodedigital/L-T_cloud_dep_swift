...
//                                    print_r($result);
                                    ...
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-medium text-white ml-1 recfrm">SCM-<?php echo $value['name'];?> <br> (<?php echo formatDate($value['scop_sentdate'], 'd-M-Y'); ?>)</span></td>
                                            ...
                                            <td>
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo formatDate($exp_date, 'd-M-Y'); ?>"  class="mydatepicker" id="dasexpected_date<?php echo $value['scop_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">
