    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">PO CREATE</h5>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">PO Create</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_swiftpo($pid, $uid, $utype, $seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-12 text-white ml-1 recfrm">
                                                    <?php echo $value['stage_name']; ?> <br> (
                                                    <?php echo $rdate; ?>)
                                                </span></td>
                                            <td>
                                                <?php
                                            ...
                                            <td style=" min-width: 130px !important;">
                                                ...
                                                <div class=" saveexp" style=" float: right;">
                                                    <span
                                                        ...
                                                        onclick="save_expected('<?php echo $value['pm_packid'] ?>', '<?php echo $value['ps_stageid'] ?>')"
                                            ...
                                            <td>
                                                <?php echo $value['ps_remarks'] ?><label
                                                    class="badge badge-pill  font-medium text-white ml-1 orange"
                                                    data-toggle="tooltip" data-original-title="Remarks"
                                                    style=" cursor: pointer;"
                                                    onclick="swal('<?php echo $value['ps_remarks'] ?>');"><i
                                                        class="fas fa-comment"></i> Remarks</label>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                if ($em == "") {
                                                    ?>
                                                    <span style="background-color:#5abf76 !important;"
                                                        class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                        onclick="swal('EMR Not Created Yet')" style=" cursor: pointer;"
                                                        data-toggle="tooltip" data-original-title="Send Packages to Tech Spoc">
                                                        <i class="fas fa-paper-plane"></i> </span>

                                                <?php } else { ?>
                                                    <span style="background-color:#5abf76 !important;"
                                                        class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                        onclick="getsid('<?php echo $getid; ?>', '<?php echo $projname; ?>', '<?php echo $value['pm_packid']; ?>', '<?php echo $value['ps_stageid'] ?>')"
                    ...
                    <div class="modal-content" style="width: 160%;margin-left: -110px;">
                        <div class="modal-header" style="padding-bottom: 3%;">
                            <h4 class="modal-title" id="exampleModalLabel1"> <span id="proj">Project Name</span> -
                                <small id="pack_name">Package Name</small></h4>
                            <!-- <h4 id="proj"></h4> &nbsp;&nbsp;-&nbsp;&nbsp; 
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                <div class=" col-md-6" id="ps" style="margin-left: 59%;">
                                    <small>ORG/REV Material Required:- <span
                                            class="badge badge-pill badge-warning font-12 text-white ml-1"
                                            id="mat_req_date"></span></small>
                                </div>
                            </div>
                        </div>
...
<small>Package send Actual <span class="badge badge-pill badge-info font-12 text-white ml-1">21-06-2019</span></small> -->
                                    ...
                                    <div class="col-md-4">
                                        <center>Package Approval<br>
                                            <span class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                id="pa_plandate">21-06-2019</span>
                                            <span class="badge badge-pill badge-info font-medium text-white ml-1"
                                                id="pa_actdate">21-06-2019</span>
                                        </center>
                                    ...
                                    <div class="col-md-4">
                                        <center>LOI <br>
                                            <span class="badge badge-pill badge-primary font-medium text-white ml-1"
                                                id="loi_plandate">21-06-2019</span>
                                            <span class="badge badge-pill badge-info font-medium text-white ml-1"
                                                id="loi_actdate">21-06-2019</span>
                                        </center>
            ...
            <div class="modal fade bs-example-modal-lg" id="model_view" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content" id="podetailvie"
                        style="width:110%;margin-left:-5%;margin-top:1%;min-height: 350px !important;max-height: 500px !important;overflow-y: scroll;">
...
<script>
    function getsid(a, b, c, d) {
        ...
        $.post("functions/po_wo_checking.php", {
            key: pack_id,
            stageid: d
        }, function (data1) {
            //console.log(data1);
    ...
    function swift_proj(Proid) {
        ...
        window.location.href = "files_from_po?pid=" + Proid + "&ptid=" + tid;
    }

    function podetailviewscm(pack_id) {
        //    alert(pack_id);
        $.post("code/podetailviewscmremove.php", {
            key: pack_id
        }, function (data) {
    ...
    function podetailviewdata(pack_id) {
        var po_number = $('#apo_num').val();
        if (po_number == '') {
            alert("Please Select Po Number");
            $('#podetailvie').hide();
            return false;
        } else {
            $.post("code/podetailviewData.php", {
                key: pack_id
            }, function (data) {
                $('#podetailvie').html(data);
            });
    ...
    function podetailviewget(pack_id) {
        ...
        if (po_number == '') {
            ...
            $.post("functions/po_api_code22.php", {
                pack_id: pack_id,
                key: po_number,
                projid: projid,
                page: page
    ...
    function save_deatils(page) {
        ...
        //else if (projid == "") {
        //     alert('Please fill Job Code');
        // }
        //            else if (api_url == "") {
        //                alert('Please fill API Url');
        //            }
        else {
            $('#save_deatils').hide();
            $('#saving').show();
            ...
            $.ajax({
                type: 'post',
                url: 'functions/po_api_code22.php',
                data: 'key=' + encodeURIComponent(po_number) + '&projid=' + encodeURIComponent(projid) + '&page=' + page + '&pack_id=' + pack_id,
                ...
                success: function (response) {
                    ...
                    if ($.trim(response) === '0') {
                        alert('Project not found in your master for the above jobcode.. Please create project and Proceed');
                    } else if ($.trim(response) === '2') {
                        alert('Warehouse not found in your master... Please create the same Warehouse and Proceed');
                    } else {
                        alert('Saved');
                        //window.location.href = 'po_master';
                        $('#podetailvie').hide();
