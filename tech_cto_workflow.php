    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Tech CTO Work Flow</h5>
            </div>
            ...
            <div class="col-lg-5 col-md-5 col-xs-12 align-self-center">              
                <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                    <ol class="breadcrumb mb-0 justify-content-end p-0 bg-light">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tech CTO Work Flow</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" style=" white-space: nowrap !important;" class="table table-striped border">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_admin->select_techCTO_workflowM($pid,$userid,$seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
...
//                                            }
                                            ...
                                            <td style=" min-width: 130px !important;"><?php // echo $expedted;        ?>
                                                <div class="input-group" id="expdiv" style=" float: left;">
                                                    ...
                                                    <input type="text" value="<?php echo $expedted; ?>"  class=" mydatepicker" id="dasexpected_date<?php echo $value['cto_packid'] ?>" name="dasexpected_date" required="" placeholder="dd/mmm/yyyy">

                                                </div>
                                                <div class=" saveexp" style=" float: right;">
                                                    <span   class="badge badge-pill badge-success font-medium text-white ml-1 sicon" onclick="save_expected('<?php echo $value['cto_packid'] ?>', '6')" data-toggle="modal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Save Expected date">
                                            ...
                                            <td><label class="badge badge-pill font-medium text-white ml-1 orange"     style=" cursor: pointer;" 
                                                ...
                                                $packname = $cls_comm->package_name($value['cto_packid']);
                                                ?>
                                            <td><span class="badge badge-pill badge-primary font-medium text-white ml-1" onclick="getctoid('<?php echo $projname; ?>', '<?php echo $value['cto_packid']; ?>', '<?php echo $value['cto_id']; ?>', '<?php echo $value['cto_projid']; ?>')" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip"  data-original-title="Send Packages to Tech Spoc"> <i class="fas fa-paper-plane"></i></span></td>
                                        </tr>
                                    <?php }  ?>
                                </tbody>
                            </table>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal_resize" style=" width: 120%;">
                        ...
                        <div class="modal-body">
                            <center>
                                <small> <span class="badge badge-pill badge-secondary orange font-12 text-white ml-1" id="senttitle">CTO Approval</span></small>                
                            </center>
...
<!--                                                <input type="text" class="form-control mydatepicker" id="exp_date" name="exp_date" required="" placeholder="mm/dd/yyyy">-->
                                ...
                                <div class="modal-footer"> 
                                    ...
                                    <button type="submit"  class="btn waves-effect waves-light btn-rounded btn-outline-danger" name="sentbacktoreviewer"  id="reject_package" data-placement="top" title="Send back to Tech Reviewer"> <i class="fas fa-times"></i> Send back to Reviewer </button> 
