...
.bg-red{
    background-color: #06bb60 !important;
    color: #fff;
}
.fa-pie-chart:before {
    content: "\f200";
...
<div class="page-wrapper ">
    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-xs-12 align-self-center">
                <select class="custom-select" name="proj_type" id="proj_type" onchange="proj_type_Filter_tech(this.value, '4')"
                    required="">
        ...
        <div class="row">
            ...
            <!-- <div class="col-lg-3 col-md-3">
                <a href="swift_workflow_approval?pid=<?php echo $pid ?>">
                    <div class="card bg-info" style="height: 150%;">
                        <div class="d-flex flex-row">
                            ...
                            <div class="text-white align-self-center p-2">
                                <span class="dascount">
                                    <h3 class="mb-0" style="font-size: 3.3125rem;">
                                        <?php
                                ...
                                <span class="text-white">Files Received From Action</span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-6 col-xl-3" style="margin-left:7%;">
                <div class="small-box bg-blue">
                    ...
                    <a href="swift_workflow_approval?pid=<?php echo $pid ?>&ptid=<?php echo $ptid; ?>" class="small-box-footer">More info <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <!-- <div class="col-lg-3 col-md-3">
                <a href="sentbackfromreviewerFlow?pid=<?php echo $pid ?>">
                    <div class="card" style=" background-color: #7D3C98;height: 150%;">
                        <div class="d-flex flex-row">
                            <div class="p-2">
                            ...
                            <div class="text-white align-self-center p-2">
                                ...
                                <span class="text-white">Files Sent Back From Action </span>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-6 col-xl-3" style="margin-left:6%;">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="sentbackfromreviewerFlow?pid=<?php echo $pid ?>&ptid=<?php echo $ptid; ?>"  class="small-box-footer">More info<i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <!-- <div class="col-lg-3 col-md-3">
            ...
            <!-- <div class="col-lg-3 col-md-3">
                <a href="swift_workflow_repository?pid=<?php echo $pid ?>">
                    <div class="card bg-success" style="background-color: #2cd07e!important;height: 150%;">
                        <div class="d-flex flex-row">
                            <div class="p-2">
                            ...
                            <div class="text-white align-self-center p-2">
                                ...
                                <span class="dascount">
                                    ...
                                    <h3 class="mb-0" style="font-size: 3.3125rem;">
                                        <?php
                                        $result = $cls_count->select_repository_count($pid, $segment);
                                        echo $result;
                                        ?>
                                    </h3>
                                </span>
              ...
              <div class="col-6 col-xl-3" style="margin-left:6%;">
                ...
                <div class="small-box bg-red">
                    ...
                    <a href="swift_workflow_repository?pid=<?php echo $pid ?>&ptid=<?php echo $ptid; ?>" class="small-box-footer">More info <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
...
<script>
    function swift_proj(Proid) {
        ...
        window.location.href = "swift_workflow?pid=" + Proid + "&ptid=" + tid;
    }
</script>
<?php
