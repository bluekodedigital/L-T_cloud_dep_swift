                        ...
                        <div class="table-responsive">
                            <table id="zero_config" style=" white-space: nowrap !important;     " class="table table-striped border">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_admin->select_techReviewer_workflow($pid,$userid);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
...
<!--                                                <input type="text" class="form-control mydatepicker" id="exp_date" name="exp_date" required="" placeholder="mm/dd/yyyy">-->
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-6" id="fetch_cto">
                                        <label for="doc_name">Select CTO</label>

                                        <select class="custom-select" name="cto_user_id" id="cto_user_id"  required=""> </select>
                                ...
                                <div class="modal-footer"> 
                                    ...
                                    <button type="submit" class="btn btn-outline-primary btn-rounded" name="sendtocto" data-toggle="tooltip" data-placement="top" title="Send to Tech CTO"><i class="fas fa-paper-plane"></i> Send to CTO / OPS</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
//            document.getElementById("exp_date").disabled = true;
                                                    ...
                                                    function swift_proj(Proid) {
                                                     ...
                                                     function fetch_cto(c, d) {
                                                        $.post("code/fetch_cto.php", {proj: d, pack: c}, function (data) {
                                                            $('#fetch_cto').html(data);
                                                        });
                                                    }
</script>
