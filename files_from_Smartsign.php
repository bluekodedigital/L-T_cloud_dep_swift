        ...
        <div class="row">
            <div class="col-12">
                <div class="material-card card">
                    <div class="pull-right" id="emr_repo"><a href="emr_repository"><button class="btn btn-primary" type="button"><i class="fa fa-eye"></i> View EMR Repository</button></a></div>
                        ...
                        <div class="table-responsive">
                            <table id="file_export" class="table table-bordered display compact">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_user->files_for_emrcreation_afterloi($pid, $segment);
                                    //                                    print_r($result);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        if ($value['ps_expdate'] == "") {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php // echo date('d-M-Y', strtotime($value['actual']));       
                                                ...
                                                <div class=" saveexp" style=" float: right;">
                                                    <span class="badge badge-pill badge-success font-medium text-white ml-1 sicon" onclick="save_expected('<?php echo $value['pm_packid'] ?>', '19')" data-toggle="modal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip" data-original-title="Save Expected date">
                                            ...
                                            <td>
                                                ...
                                                <span onclick="filesforemr('<?php echo $value['pm_packid'] ?>')" class="badge badge-pill badge-primary font-medium text-white ml-1" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style=" cursor: pointer;" data-toggle="tooltip" data-original-title="Send Packages">
                                                    <i class="fas fa-paper-plane"></i>
                                                </span>
                                            </td>
                                        </tr>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal_resize" style=" width: 120%;">
                        ...
                        <form method="post" action="functions/move_to_next_stage" autocomplete="off" onsubmit="return confirm('Are you sure you want to submit?');">
                            <div class="modal-body">
                                
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                            <label for="loi_number" class="control-label">LOI Number : </label>
                                            <span class="badge badge-pill badge-primary  font-12 text-white ml-1" id="loi_number" name="loi_number"> </span>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="loi_date">LOI Date : </label>
                                            <span class="badge badge-pill badge-primary  font-12 text-white ml-1" id="loi_date" name="loi_date"> </span>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <center>
                                    <small> <span class="badge badge-pill badge-secondary orange font-12 text-white ml-1" id="senttitle">EMR Creation </span></small>
                                </center>
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="actual_date">EMR Action Date</label>
                                        <div class="input-group">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="icon-calender"></i></span>
                                            </div>
