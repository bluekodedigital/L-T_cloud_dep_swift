    ...
    <div class="page-breadcrumb bg-light">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12 align-self-center">
                <h5 class="font-medium text-uppercase mb-0">Buyer Repository</h5>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="file_export" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $result = $cls_comm->select_smartsignoff_buyer_repo($pid, $uid, $utype,$seg);
                                    $res = json_decode($result, true);
                                    foreach ($res as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-pill badge-info font-12 text-white ml-1"><?php echo $get_loidetails['loi_number']; ?></span></td>
                                            <td>
                                                <span class="badge badge-pill badge-info font-12 text-white ml-1">
                                                    <?php
                                            ...
                                            <td><span class="badge badge-pill badge-info font-12 text-white ml-1"><?php echo $get_loidetails['po_number']; ?></span></td>
                                            <td><span class="badge badge-pill badge-info font-12 text-white ml-1"><?php echo $get_loidetails['wo_number']; ?></span></td>
                                            <td>
                                                <?php
                                                if ($value['so_hw_sw'] == 1) {
                                                    echo "WO Only";
                                            ...
                                            <td><span class="badge badge-pill badge-primary font-medium text-white ml-1"  alt="default" data-toggle="modal" data-target="#model_view" class="model_img img-fluid" onclick="podetailviewscm('<?php echo $value['so_pack_id']; ?>')" ><i class="fas fa-eye"></i></span>
                                            </td>
...
<script>
                                                       ...
                                                       function swift_proj(Proid) {
                                                           window.location.href = "buyer_repository?pid=" + Proid;
                                                       }
